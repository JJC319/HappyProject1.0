...
/**
 * Created by cjj on 2016/10/23 下午7:30.
 * Description: 自定义EditText实现右下角计数控件
 */
...
public class AnFQNumEditText extends RelativeLayout {
    ...
    public AnFQNumEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.anfqnum_edittext, this, true);
     ...
     * @param isShow
     */
    public void isShowNumViewAndLine(boolean isShow){
        tvNum.setVisibility(isShow ? View.VISIBLE : View.GONE);
        vLine.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }
